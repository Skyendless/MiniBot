...
void mobile_manipulator::on_pushButton_clicked()
{
  cmd->close();
  serial->close();
  this->close();
...
void mobile_manipulator::on_pushButton_remote_clicked()
{
  if(serial->isOpen()){
      serial->close();
...
void mobile_manipulator::on_pushButton_mapping_clicked()
{
...
void mobile_manipulator::handleError(QSerialPort::SerialPortError error)
{
...
void mobile_manipulator::keyPressEvent(QKeyEvent *e)
{
  switch(e->key())
  {
    case Qt::Key_W:
...
void mobile_manipulator::keyReleaseEvent(QKeyEvent *e)
{
  switch(e->key())
  {
    case Qt::Key_W:
...
void mobile_manipulator::first_data(void)
{
  buff = "zxc";
  if(bot_selet == 2)
   {
...
void mobile_manipulator::on_pushButton_grab_clicked()
{
    first_data();
    buff.append("M");
